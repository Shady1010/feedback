...
<div class="button"><button onclick="openForm()">Обратная связь</button></div>
    <div class="form" id="form" >
        ...
        <form method="get" class="form-container"  id="form_container">
            ...
            <input type="text" placeholder="Ваше имя" name="name"  id="name" autocomplete="off"  onkeyup="change('name')" required>

            <label for="phone">Ваш номер телефона*</label> <span style="color:red" id="phonePlace"></span>
            <input type="tel" placeholder="Номер телефона" minlength="11" maxlength="11" name="phone" id="phone" autocomplete="false"  onkeyup="change('phone')" required>
            ...
            <button type="button" id="submit" onclick="connect(document.getElementById('name').value, document.getElementById('phone').value, document.getElementById('comment').value)"  class="btn-sumbit">ОТПРАВИТЬ</button>
    ...
    <div id="report" class="report">
        <button type="submit" class="cancel"   onclick="closeForm() "><img src="img/close.png" width="28" height="28"></button>
