...
<div class="button"><button onclick="openForm()">Обратная связь</button></div>
    <div class="form" id="form" >
        ...
        <form onsubmit="connect(document.getElementById('name').value, document.getElementById('phone').value, document.getElementById('comment').value)"  method="get" class="form-container" id="form_container">
            ...
            <input type="tel" placeholder="Номер телефона" minlength="11" name="phone" id="phone"  onkeyup="change('phone')" required>
            ...
            <button type="submit" id="submit"  class="btn-sumbit">ОТПРАВИТЬ</button>
